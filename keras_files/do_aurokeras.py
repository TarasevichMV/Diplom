...
auto_model = ak.AutoModel(
    inputs=input_node,
    outputs=output_node,
    max_trials=10,  # Количество попыток для поиска наилучшей модели
    directory='my_dir',
...
auto_model.fit(train_texts, train_labels, epochs=50, validation_data=(test_texts, test_labels), batch_size=32, callbacks=[csv_logger])
...
# Сохранение модели
auto_model.export_model().save('best_text_classification_model.h5')
